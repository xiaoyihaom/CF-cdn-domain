...
let userID = '816952fb-d8f8-4d00-808b-9d582d434016';
			...
			if (!upgradeHeader || upgradeHeader !== 'websocket') {
				...
				switch (url.pathname) {
					...
					default:
						...
						url.hostname = ['www.fmprc.gov.cn', 'tv.cctv.com', 'www.xuexi.cn', 'www.gov.cn', 'mail.gov.cn', 'www.mofcom.gov.cn', 'www.gfbzb.gov.cn', 'www.miit.gov.cn', 'www.12377.cn'];
						url.protocol = 'https:';
